...
# === CONFIGURATION ===
INPUT_CSV_PATH = "path_to_input_file.csv"
OUTPUT_CSV_PATH = "path_to_output_file.csv"

# === SYSTEM PROMPT ===
sys_text = "You're a Spanish-English linguistic tagger. Your job is to correctly tag various linguistic components of a Spanish-English code-switch sentence. Make use of the instructions provided to you in the use prompt."
...
def main():
    ...
    for idx, row in tqdm(df.iterrows(), total=len(df), desc="Processing Sentences"):
        ...
        multiple_words = row['multiple_words']
        ...
        try:
            ...
            if start_idx == -1 or end_idx == -1:
                print(f"Invalid JSON brackets for sentence_id {sentence_id}")
                continue
            ...
            for token_info in tokens_info:
                ...
                if not gpt_tokens_for_id:
                    print(f"No GPT match for token_id {token_id} in sentence_id {sentence_id}")
                    continue
